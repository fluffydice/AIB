...
$ARMtemp = 'C:\Scripting\Azure\AIB\ImageTemplateSIG-APPS.json'
$apiVersion = '2019-05-01-preview'
$imageTemplateName = 'Win2004Template04' # Template name must be unique - upgrade of image templates currently not supported
$imageName = 'win102004Image01' # Not needed if using SIG ??
$sharedImageGallery = 'LPImageGallery001' # Keep the same
$imageDefName = 'win10Images' # Keep the same
$imageVer = '1.0.1' # Increment for each image
